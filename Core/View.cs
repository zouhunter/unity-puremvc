...
namespace PureMVC.Core
{
    ...
    {
        protected IDictionary<string, IMediatorIner> m_mediatorMap;
        ...
        protected View()
        {
            m_mediatorMap = new Dictionary<string, IMediatorIner>();
        ...
        /// </summary>
        /// <param name="notify"></param>
        public IMediatorIner RemoveMediator(string mediatorName)
        {
            IMediatorIner mediator = null;

            lock (m_syncRoot)
            {
                if (!m_mediatorMap.ContainsKey(mediatorName)) return null;
                mediator = (IMediatorIner)m_mediatorMap[mediatorName];

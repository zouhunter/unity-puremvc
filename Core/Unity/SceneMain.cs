...
public class SceneMain : MonoBehaviour
{
    ...
    public class EventHold
    {
        ...
        public void AddDelegate(string key, Action handle)
        {
            if (handle == null) return;
        ...
        public void RemoveDelegate(string key, Action handle)
        {
            ReMoveObserver(key, handle);
        }
    ...
    #region 访问事件系统
    public void RegisterEvent(string noti, Action even)
    {
    ...
    public void RemoveEvent(string noti, Action even)
    {
